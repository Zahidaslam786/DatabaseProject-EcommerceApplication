...
namespace DB_LAB_PROJECT
{
    public partial class Fashion : Form
    {
        ...
        private int[] ProductId = { 9, 10, 11, 12,13, 14, 15, 16 };
        ...
        private void button9_Click(object sender, EventArgs e)//back 
        {
        ...
        {
            AddProductToCart(ProductId[0]); // Product ID 8
        }

        private void button2_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[1]); // Product ID 9
        }

        private void button1_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[2]); // Product ID 10
        }

        private void button4_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[3]); // Product ID 11
        }

        private void button15_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[4]); // Product ID 12
        }

        private void button9_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[5]); // Product ID 13
        }

        private void button7_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[6]); // Product ID 14
        }

        private void button5_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[7]); // Product ID 15
        }
    }
}
