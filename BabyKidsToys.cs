...
{
    public partial class BabyKidsToys : Form
    {
        ...
        private int[] ProductId = { 25, 26, 27, 28, 29, 30, 31, 32 };
        ...
        private void BabyKidsToys_Load(object sender, EventArgs e)
        {
        ...
        {
            AddProductToCart(ProductId[0]); // Product ID 25
        }

        private void button2_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[1]); // Product ID 26
        }

        private void button1_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[2]); // Product ID 27
        }

        private void button4_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[3]); // Product ID 28
        }

        private void button15_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[4]); // Product ID 29
        }

        private void button9_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[5]); // Product ID 30
        }

        private void button7_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[6]); // Product ID 31
        }

        private void button5_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[7]); // Product ID 32
        }
    }
}
