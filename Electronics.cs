...
namespace DB_LAB_PROJECT
{
    public partial class Electronics : Form
    {
        ...
        private int[] ProductId = { 1, 2, 3, 4, 5, 6, 7, 8 };
        ...
        {
            AddProductToCart(ProductId[0]); // Product ID 1
        }
        ...
        {
            AddProductToCart(ProductId[1]); // Product ID 2
        }
        ...
        {
            AddProductToCart(ProductId[2]); // Product ID 3
        }

        private void button4_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[3]); // Product ID 4
        }

        private void button7_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[4]); // Product ID 5
        }

        private void button8_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[5]); // Product ID 6
        }

        private void button6_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[6]); // Product ID 7
        }

        private void button5_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[7]); // Product ID 8
        }
    }
}
