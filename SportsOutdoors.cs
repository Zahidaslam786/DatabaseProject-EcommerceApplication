...
{
    public partial class SportsOutdoors : Form
    {
        ...
        {
            AddProductToCart(ProductId[0]); // Product ID 33
        }

        private void button2_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[1]); // Product ID 34
        }

        private void button1_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[2]); // Product ID 35
        }

        private void button4_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[3]); // Product ID 36
        }

        private void button15_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[4]); // Product ID 37
        }

        private void button9_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[5]); // Product ID 38
        }

        private void button7_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[6]); // Product ID 39
        }

        private void button5_Click_1(object sender, EventArgs e)
        {
            AddProductToCart(ProductId[7]); // Product ID 40
        }
    }
}
